                    ...
                    for (
                        ...
                        if (greedy && i != strarr.length - 1) {
                            ...
                            for (
                                ...
                                k < len &&
                                (p < to ||
                                    (!strarr[k].type && !strarr[k - 1].greedy));
                                ++k
                            ) {
                                p += strarr[k].length;
    ...
    buildPlaceholders: {
        ...
        value: function (env, language, placeholderPattern, replaceFilter) {
            ...
            env.code = env.code.replace(placeholderPattern, function (match) {
                ...
                while (
                    env.code.indexOf(
                        "___" + language.toUpperCase() + i + "___"
                    ) !== -1
                )
                    ++i;
                ...
                for (var i = 0; i < tokens.length; i++) {
                    ...
                    if (
                        ...
                        if (index > -1) {
                            ...
                            var replacement;
                            if (before || after) {
                                replacement = [before, middle, after].filter(
                                    function (v) {
                                        return !!v;
                                    }
                                );
    ...
    var _resizeElement = function (element) {
        ...
        if (whiteSpace === "pre-wrap" || whiteSpace === "pre-line") {
            ...
            codeLines.forEach(function (line, lineNumber) {
                ...
                lineNumbersWrapper.children[lineNumber].style.height =
                    lineSize + "px";
            });
    ...
    var previewers = {
        ...
        gradient: {
            create: (function () {
                 ...
                 */
                var convertToW3CLinearGradient = function (
                    prefix,
                    func,
                    values
                ) {
                        ...
                        if (angle.indexOf("to ") < 0) {
                            ...
                            if (angle.indexOf("top") >= 0) {
                                ...
                                if (angle.indexOf("deg") >= 0) {
                                    ...
                                    angle =
                                        Math.PI / 2 - parseFloat(angle) + "rad";
                                }
                            }
                        }
                    }
                 ...
                 * @param {string[]} values Array of the gradient function parameters (["0deg", "red 0%", "blue 100%"])
                 */
                var convertToW3CRadialGradient = function (
                    prefix,
                    func,
                    values
                ) {
                ...
                stylus: [
                    {
                        ...
                        root:
                            ...
                            Prism.languages.stylus["property-declaration"]
                                .inside,
                    },
                    {
                        lang: "stylus",
                        ...
                        root:
                            Prism.languages.stylus &&
                            Prism.languages.stylus["variable-declaration"]
                                .inside,
                    },
                ],
            },
    ...
    Previewer.prototype.isDisabled = function (token) {
        do {
            if (token.hasAttribute && token.hasAttribute("data-previewers")) {
                ...
                return (
                    (previewers || "").split(/\s+/).indexOf(this._type) === -1
                );
            }
